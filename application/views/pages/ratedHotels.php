...
<html>
    ...
    <div style="margin: auto; max-width: 60%;">
        ...
        <h2 style="text-align:center; padding-top:20px;">Rated Hotels<h2>
        <div class="row row-cols-1 row-cols-md-3 g-4" style="padding-top:2%;">
            ...
            <div class="col">
                <div class="card h-100">
                    ...
                    <div class="card-body">
                        ...
                        <a href="https://www.shangri-la.com/manila/edsashangrila/" target="_blank" class="btn btn-outline-primary" style="float:right; display:inline; border-color:#302DB9;">Go to Site</a>
        ...
        <div class="col">
                <div class="card h-100">
                    ...
                    <div class="card-body">
                        ...
                        <a href="https://www.diamondhotel.com/" target="_blank" class="btn btn-outline-primary" style="float:right; display:inline; border-color:#302DB9;">Go to Site</a>
            ...
            <div class="col">
                <div class="card h-100">
                    ...
                    <div class="card-body">
                        ...
                        <a href="https://www.dusit.com/dusitthani-manila/" target="_blank" class="btn btn-outline-primary" style="float:right; display:inline; border-color:#302DB9;">Go to Site</a>
        ...
        <div class="col">
                <div class="card h-100">
                    ...
                    <div class="card-body">
                        ...
                        <a href="https://www.nicholsairporthotel.com.ph/" target="_blank" class="btn btn-outline-primary" style="float:right; display:inline; border-color:#302DB9;">Go to Site</a>
            ...
            <div class="col">
                <div class="card h-100">
                    ...
                    <div class="card-body">
                        ...
                        <a href="https://88courtyardhotel.com.ph/" target="_blank" class="btn btn-outline-primary" style="float:right; display:inline; border-color:#302DB9;">Go to Site</a>
           ...
           <div class="col">
                <div class="card h-100">
                    ...
                    <div class="card-body">
                        ...
                        <a href="https://www.millenniumhotels.com/en/manila/the-heritage-hotel-manila/?cid=gplaces-the-heritage-hotel-manila" target="_blank" class="btn btn-outline-primary" style="float:right; display:inline; border-color:#302DB9;">Go to Site</a>
                             <p style="font-size:30px">RR: 
                            <img src="../../img/bamboo2.png" alt="Resilience Rating" class="bamboo">          
                    </div>
                </div>
